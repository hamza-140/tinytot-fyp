...
import IslamWorkbook from './IslamWorkbook';

const IslamComponent = ({widthBar}) => {
    ...
    const fetchCompletedMathLessons = async () => {
      try {
        ...
        if (currentUser) {
          ...
          const math = parentDoc.data().islamiyat;
          ...
          console.log('comp:', completedLessons);
    ...
    <ScrollView
      ...
      <View style={{display: 'flex', flexDirection: 'row'}}>
        <CardComponent
          ...
          bg={'#A5FECA'}
          onPress={() => {
            navigation.navigate('Working', {category: 'Islamiyat'});
          }}
        />
        ...
        <Modal
          ...
          <View style={styles.modalContainer}>
            <View style={styles.modalView}>
              <ScrollView>
                <IslamWorkbook completedLessons={completedMathLessons} />
